    ...
    <AdminLayout>
      <div className="flex min-h-0 flex-1 gap-4">
        ...
        >
          ...
          <form onSubmit={handleSend} className="flex items-center gap-2 border-t border-border p-3" data-tutorial-target="message-attachment">
            <Input
              ref={inputRef}
            ...
            <div data-tutorial-target="message-audio">
              <AudioRecorder
                ...
                onRecordingComplete={(blob) => {
                  ...
                  setAttachment(new File([blob], `audio-${Date.now()}.webm`, { type: "audio/webm" }));
